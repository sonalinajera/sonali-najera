  ...
  render() {
    return (
      <section>
        ...
        <section>
          <h2>Designer</h2>
          <p>I push myself to become a better visual designer to create colorful and impactful flows with functionality.</p>
          <h3>Tools</h3>
          <p>Balsamiq, Figma, Pen/Paper, Color theory, Adobe design tools, </p>
        </section>
        <section>
